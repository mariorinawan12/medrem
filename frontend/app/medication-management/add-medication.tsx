...
import { createMedicationForSelf } from '@/lib/medication';
...
export default function AddMedicationScreen() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      await createMedicationForSelf(body);
      ...
      const route = userRole === 'main_user' 
        ? '/(drawer)/(tabs-amain)/medication-management'
        : '/(drawer)/(tabs-dependent)/medication-management';
      router.push(route);
    } catch (err) {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.content}>
          <View style={styles.header}>
            <TouchableOpacity style={styles.backButton} onPress={() => router.replace('/(drawer)/(tabs-amain)/medication-management')}>
